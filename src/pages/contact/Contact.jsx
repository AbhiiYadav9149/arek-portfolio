...
const sendEmail = (e) => {
  ...
  emailjs
    .send('service_mbtf9s3', 'template_s4tfqpf', formData, 'PEA33JRR6t3ROanHZ')
    .then(
      () => {
        ...
        <div className="contact-content grid">
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">Shikohabad, Firozabad, Uttar Pradesh, India</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">arekyara9175@gmail.com</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">+91 9149184310</p>
            </div>
          </div>
